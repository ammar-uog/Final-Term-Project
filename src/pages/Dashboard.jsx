...
const DashboardPage = () => {
    ...
    const handleLogout = () => {
        ...
        router.push('/login'); // Navigate using Next.js App Router
    };
    ...
    const upcomingMeetings = [
        { id: 1, title: 'Product Launch Review', time: '10:00 AM', date: 'Today', participants: 8, duration: '45 min', type: 'video', priority: 'high' },
        { id: 2, title: 'Design Sprint Planning', time: '2:30 PM', date: 'Today', participants: 5, duration: '60 min', type: 'conference', priority: 'medium' },
        { id: 3, title: 'Client Q4 Review', time: '11:00 AM', date: 'Tomorrow', participants: 12, duration: '90 min', type: 'video', priority: 'high' },
    ];

    const recentMinutes = [
        { id: 1, title: 'Weekly Team Sync', date: '2 hours ago', duration: '45 min', participants: 8, status: 'processed', aiGenerated: true },
        { id: 2, title: 'Client Presentation Review', date: '1 day ago', duration: '60 min', participants: 6, status: 'reviewed', aiGenerated: true },
        { id: 3, title: 'Product Strategy Meeting', date: '2 days ago', duration: '90 min', participants: 10, status: 'published', aiGenerated: true },
    ];

    const quickActions = [
        { title: 'Schedule Meeting', description: 'AI-powered scheduling with optimal time detection', icon: CalendarIcon, color: 'bg-blue-500 hover:bg-blue-600', action: () => setActiveTab('schedule') },
        { title: 'Generate Minutes', description: 'Convert recordings to organized meeting notes', icon: DocumentTextIcon, color: 'bg-emerald-500 hover:bg-emerald-600', action: () => setActiveTab('minutes') },
        { title: 'Calendar Sync', description: 'Connect Google Calendar & Outlook', icon: CogIcon, color: 'bg-purple-500 hover:bg-purple-600', action: () => setActiveTab('settings') },
    ];
    ...
    <div className="xl:col-span-2 bg-slate-800 rounded-xl border border-slate-700">
        ...
        <div className="p-4">
            {upcomingMeetings.map((meeting) => (
                ...
                >
                    <div className="flex items-center space-x-3">
                        <div className={`w-2 h-8 rounded-full ${meeting.priority === 'high' ? 'bg-red-500' : 'bg-amber-500'}`}></div>
                        <div>
