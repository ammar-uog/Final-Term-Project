        ...
        <div className="py-16 sm:py-24 px-4 flex items-center justify-center">
            <div className="max-w-md w-full mx-auto">
                <div className="text-center">
                    <h2 className="text-3xl font-extrabold text-white sm:text-4xl">Create a new account</h2>
                    <p className="mt-4 text-lg text-gray-400">
                        Or{' '}
                        <a href="#" onClick={(e) => { e.preventDefault(); setCurrentPage('Login'); }} className="font-medium text-[#7B61FF] hover:text-[#00FFFF]">
                ...
                <div className="mt-12 bg-slate-800/50 p-8 rounded-lg border border-slate-700">
                    <form className="space-y-6">
                        <div>
                            ...
                            <div className="mt-1">
                                <input id="name" name="name" type="text" autoComplete="name" required className="block w-full px-4 py-3 rounded-md bg-slate-800 border-slate-600 text-white focus:outline-none focus:ring-2 focus:ring-[#7B61FF]" />
                            </div>
                        </div>
                        <div>
                        ...
                        <div>
                            ...
                            <div className="mt-1">
                                <input id="password" name="password" type="password" autoComplete="new-password" required className="block w-full px-4 py-3 rounded-md bg-slate-800 border-slate-600 text-white focus:outline-none focus:ring-2 focus:ring-[#7B61FF]" />
                            </div>
                        </div>
